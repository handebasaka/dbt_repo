-- Goal: A table showing weekly averages and total counts, 
--including location and geo information.
...
aggregations_adding_features AS (
    SELECT
        ...
        SUM(CASE WHEN condition_text in
            ('Overcast', 'Partly cloudy', 'Cloudy', 'Freezing fog') THEN 1 ELSE 0 END) AS other_days,
        SUM(CASE WHEN condition_text in
        ...
        SUM(CASE WHEN condition_text in 
            ...
            'Patchy sleet possible', 'Ice pellets') THEN 1 ELSE 0 END) AS snowy_days
